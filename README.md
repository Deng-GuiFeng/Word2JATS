...
将学术论文 DOCX 转换为 JATS 1.3 XML 与配套图片，并提供成品预览、原稿定位核对和复核记录。在线入口：[word2jats.jianglab.work](https://word2jats.jianglab.work)。

## 方法与使用价值

模型负责理解结构，程序按原稿位置取回正文与文献内容；文首作者、机构等采用受检查约束的局部 JATS 通道。自动检查结合源文覆盖、输出来源、DTD、媒体及引用关系；编辑查看原稿摘录，确认或修订疑难项，再导出结果与复核记录。
