...
def head_jats_pass(view: SerializedDocument, llm,
    ...
    if boundary_failures:
        ...
        return HeadJatsResult(
            "head-jats", "head-jats-v1.3", None, (), (boundary_audit,), issues,
        )

    if boundary.get("last_head_node") is None:
        return HeadJatsResult(
            "head-jats", "head-jats-v1.3", None, (), (boundary_audit,), (),
        )
    ...
    route = f"v2:head-jats:head-jats-v1.3:head-0-{last_index}"
    ...
    audit = {
        **meta, "task": "head-jats", "prompt_version": "head-jats-v1.3",
    ...
    return HeadJatsResult(
        "head-jats", "head-jats-v1.3", response, front_nodes,
